...
class DocumentIngestionPipeline:
    ...
    async def _ingest_single_document(self, file_path: str) -> IngestionResult:
        ...
        try:
            doc_result = await self.document_processor.process_document(file_path)
        ...
        document_metadata.update(self._extract_document_metadata(document_content, file_path))
        document_metadata['original_file_type'] = file_type
    ...
    def _find_document_files(self) -> List[str]:
        ...
        # Get supported extensions from document processor
        supported_extensions = self.document_processor.get_supported_extensions()
        
        # Create patterns for glob
        ...
        # Filter to only include files that the processor can handle
        supported_files = [f for f in files if self.document_processor.is_supported(f)]
